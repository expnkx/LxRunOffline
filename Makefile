CC := g++
CPPFLAGS := -std=c++20 -DUNICODE -D_UNICODE -D_WIN32_WINNT=0x0A00
LDFLAGS := -municode -static -static-libgcc -static-libstdc++ -s
LDLIBS := -lntdll -lole32 -luuid -larchive.dll -lboost_program_options-mt -lexpat -lbz2 -llz4 -liconv -llzma -lz -lnettle -lzstd -lbcrypt tinyxml2.o -fdata-sections -ffunction-sections -Wl,--gc-sections
